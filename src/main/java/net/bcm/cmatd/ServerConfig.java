...
public class ServerConfig {
    ...
    public static final ModConfigSpec.IntValue LIGHTNING_GEN_RATE = BUILDER
            .comment("The FE generated per strike on the Lightning Generator")
            .translation("cmatd.configuration.lightning_gen_rate.tooltip")
            .defineInRange("lightning_gen_rate",
                    1_000_000,
                    1, Integer.MAX_VALUE);

    public static final ModConfigSpec.IntValue LIGHTNING_GEN_MAX_CAPACITY = BUILDER
            .comment("The max FE that can be stored in the Lightning Generator")
            .translation("cmatd.configuration.lightning_gen_capacity.tooltip")
            .defineInRange("lightning_gen_capacity",
                    16_000_000,
                    1,Integer.MAX_VALUE);

    public static final ModConfigSpec.IntValue LIGHTNING_GEN_COOLDOWN_TIME = BUILDER
            .comment("The cooldown time left applied to the Lightning Generator when struck")
            .translation("cmatd.configuration.lightning_gen_cooldown_time.tooltip")
            .defineInRange("lightning_gen_cooldown_time",
                    50,
                    25,250);

    public static final ModConfigSpec.IntValue LIGHTNING_GEN_TIMER_SCALE = BUILDER
            .comment("The time scale in ticks that controls cooldown time left for the Lightning Generator")
            .translation("cmatd.configuration.lightning_gen_timer_scale.tooltip")
            .defineInRange("lightning_gen_timer_scale",
                    150,
                    25,150);

    public static final ModConfigSpec.IntValue LIGHTNING_GEN_MAX_RECEIVE_SEND = BUILDER
            .comment("The max speed of energy transfer for the Lightning Generator")
            .translation("cmatd.configuration.lightning_gen_max_receive_send.tooltip")
            .defineInRange("lightning_gen_max_receive_send",
                    2_000_000,
                    1,Integer.MAX_VALUE);
    ...
    public static final ModConfigSpec.BooleanValue RADIOACTIVE_REACTOR_EXPLODES_WHEN_TOO_HOT = BUILDER
            ...
            .translation("cmatd.configuration.radioactive_reactor_blows_up_when_too_hot.tooltip")
    ...
    public static final ModConfigSpec.BooleanValue RADIOACTIVE_REACTOR_MAKES_DAMAGE_SOUNDS = BUILDER
            ...
            .translation("cmatd.configuration.radioactive_reactor_makes_damage_sounds.tooltip")
