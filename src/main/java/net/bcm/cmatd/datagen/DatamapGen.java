...
public class DatamapGen extends DataMapProvider {
    ...
    protected void gather(HolderLookup.Provider provider) {
        ...
        builder(Cmatd.JAMMABLES)
                ...
                .add(Items.GLISTERING_MELON_SLICE.builtInRegistryHolder(),new Jammables(CmatdItem.GLISTERING_MELON_JAM.asItem()),false)
                .add(Items.GLOW_INK_SAC.builtInRegistryHolder(),new Jammables(CmatdItem.GLOW_INK_JAM.asItem()),false)
