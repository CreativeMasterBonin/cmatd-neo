...
public class RedstoneDynamoEngineBERenderer implements BlockEntityRenderer<RedstoneDynamoEngineBE> {
    private RedstoneDynamoEngineModel model;

    public RedstoneDynamoEngineBERenderer(BlockEntityRendererProvider.Context berp){
        model = new RedstoneDynamoEngineModel(berp.bakeLayer(RedstoneDynamoEngineModel.LAYER_LOCATION));
    }

    @Override
    public boolean shouldRenderOffScreen(RedstoneDynamoEngineBE blockEntity) {
        return true;
    }
    ...
    @Override
    public boolean shouldRender(RedstoneDynamoEngineBE be, Vec3 vec3) {
    ...
    @Override
    public void render(RedstoneDynamoEngineBE be, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        poseStack.pushPose();
    ...
    @Override
    public AABB getRenderBoundingBox(RedstoneDynamoEngineBE blockEntity) {
